...
export type Unnamed_2_Query = { allMarkdownRemark: { group: Array<(Pick<MarkdownRemarkGroupConnection, 'fieldValue' | 'totalCount'> & { edges: Array<{ node: (Pick<MarkdownRemark, 'excerpt'> & { fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'categories' | 'title' | 'tags' | 'keywords'>> }) }> })> } };

export type Unnamed_3_QueryVariables = {};


export type Unnamed_3_Query = { allMarkdownRemark: { edges: Array<{ node: (Pick<MarkdownRemark, 'excerpt'> & { fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'tags' | 'categories'>> }) }> } };

export type Unnamed_4_QueryVariables = {};


export type Unnamed_4_Query = { allMarkdownRemark: { edges: Array<{ node: (Pick<MarkdownRemark, 'rawMarkdownBody' | 'excerpt'> & { fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'tags' | 'categories'>> }) }> } };

export type Unnamed_5_QueryVariables = {};


export type Unnamed_5_Query = { allMarkdownRemark: { group: Array<(Pick<MarkdownRemarkGroupConnection, 'fieldValue' | 'totalCount'> & { edges: Array<{ node: (Pick<MarkdownRemark, 'excerpt'> & { fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'tags' | 'categories' | 'keywords'>> }) }> })> } };
...
export type Unnamed_6_Query = { markdownRemark: Maybe<(Pick<MarkdownRemark, 'html' | 'excerpt' | 'tableOfContents'> & { fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'tags' | 'categories' | 'keywords'>> })> };
