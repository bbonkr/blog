...
export type SitePluginFieldsEnum = 
  ...
  | 'pluginOptions___services___Instagram___accessToken'
  | 'nodeAPIs'
  | 'browserAPIs'
  | 'ssrAPIs'
  | 'pluginFilepath'
...
export type SitePluginPluginOptions = {
  ...
  services?: Maybe<SitePluginPluginOptionsServices>;
};
...
export type SitePluginPluginOptionsFilterInput = {
  ...
  services?: Maybe<SitePluginPluginOptionsServicesFilterInput>;
};
...
export type SitePluginPluginOptionsPluginsPluginOptions = {
  ...
  services?: Maybe<SitePluginPluginOptionsPluginsPluginOptionsServices>;
};
...
export type SitePluginPluginOptionsPluginsPluginOptionsFilterInput = {
  ...
  services?: Maybe<SitePluginPluginOptionsPluginsPluginOptionsServicesFilterInput>;
};

export type SitePluginPluginOptionsPluginsPluginOptionsServices = {
  Instagram?: Maybe<SitePluginPluginOptionsPluginsPluginOptionsServicesInstagram>;
};

export type SitePluginPluginOptionsPluginsPluginOptionsServicesFilterInput = {
  Instagram?: Maybe<SitePluginPluginOptionsPluginsPluginOptionsServicesInstagramFilterInput>;
};

export type SitePluginPluginOptionsPluginsPluginOptionsServicesInstagram = {
  accessToken?: Maybe<Scalars['String']>;
};

export type SitePluginPluginOptionsPluginsPluginOptionsServicesInstagramFilterInput = {
...
export type SitePluginPluginOptionsServices = {
  Instagram?: Maybe<SitePluginPluginOptionsServicesInstagram>;
};

export type SitePluginPluginOptionsServicesFilterInput = {
  Instagram?: Maybe<SitePluginPluginOptionsServicesInstagramFilterInput>;
};

export type SitePluginPluginOptionsServicesInstagram = {
  accessToken?: Maybe<Scalars['String']>;
};

export type SitePluginPluginOptionsServicesInstagramFilterInput = {
  accessToken?: Maybe<StringQueryOperatorInput>;
};
...
export type Unnamed_2_Query = { allMarkdownRemark: { edges: Array<{ node: { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'tags' | 'categories'>> } }> } };

export type Unnamed_3_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_3_Query = { allMarkdownRemark: { group: Array<(
      Pick<MarkdownRemarkGroupConnection, 'fieldValue' | 'totalCount'>
      & { edges: Array<{ node: (
          Pick<MarkdownRemark, 'excerpt'>
          & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'categories' | 'title' | 'tags' | 'keywords'>> }
        ) }> }
    )> } };
...
export type Unnamed_4_Query = { allMarkdownRemark: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'excerpt'>
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'tags' | 'categories'>> }
      ) }> } };

export type Unnamed_5_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_5_Query = { allMarkdownRemark: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'rawMarkdownBody' | 'excerpt'>
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'tags' | 'categories'>> }
      ) }> } };
...
export type Unnamed_6_Query = { allMarkdownRemark: { group: Array<(
      Pick<MarkdownRemarkGroupConnection, 'fieldValue' | 'totalCount'>
      & { edges: Array<{ node: (
          Pick<MarkdownRemark, 'excerpt'>
          & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'tags' | 'categories' | 'keywords'>> }
        ) }> }
    )> } };
...
export type Unnamed_7_Query = { markdownRemark?: Maybe<(
    Pick<MarkdownRemark, 'html' | 'excerpt' | 'tableOfContents'>
    & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'tags' | 'categories' | 'keywords'>> }
  )> };
